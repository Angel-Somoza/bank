      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
          <span style={{ fontSize: '24px', fontWeight: 'bold', letterSpacing: '0.5px', color: '#b1c7f2' }}>
            ...
            {/* Blobs */}
            <div style={{ position: "absolute", top: "-160px", right: "-160px", width: "384px", height: "384px", background: "rgba(74,225,118,0.08)", borderRadius: "50%", filter: "blur(80px)", animation: "float 20s ease-in-out infinite alternate" }} />
            <div style={{ position: "absolute", bottom: "-160px", left: "-160px", width: "384px", height: "384px", background: "rgba(177,199,242,0.08)", borderRadius: "50%", filter: "blur(80px)", animation: "float 20s ease-in-out infinite alternate", animationDelay: "-5s" }} />
            ...
            <main style={{ paddingTop: "120px", paddingBottom: "120px", paddingLeft: "40px", paddingRight: "40px", maxWidth: "1200px", margin: "0 auto", position: "relative", zIndex: 2 }}>
                ...
                <div style={{
                    ...
                    animation: "fadeInUp 0.8s ease-out forwards", opacity: 0, animationFillMode: "forwards",
                }}>
                        ...
                        return (
                            ...
                            >
                                ...
                                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                                    ...
                                    <span className="material-symbols-outlined card-icon" style={{ fontSize: "36px", color: defaultColor, transition: "color 0.2s ease" }}>
                                ...
                                <div style={{ borderTop: "1px solid rgba(68,71,78,0.3)", paddingTop: "24px", display: "flex", flexDirection: "column", gap: "16px" }}>
                                    <div>
                                        ...
                                        <p className="card-saldo" style={{ fontSize: "48px", fontWeight: "700", color: defaultColor, transition: "color 0.2s ease" }}>
                                    ...
                                    <button
                                        ...
                                        style={{ width: "100%", padding: "16px", background: "transparent", border: "1px solid rgba(142, 144, 153, 0.2)", borderRadius: "12px", color: "#dae2fd", fontSize: "16px", fontWeight: "600", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: "8px", transition: "all 0.2s ease" }}
                                        onMouseEnter={(e) => { e.currentTarget.style.background = "rgba(74,225,118,0.1)"; e.currentTarget.style.borderColor = "#4ae176"; e.currentTarget.style.color = "#4ae176"; }}
                                        onMouseLeave={(e) => { e.currentTarget.style.background = "transparent"; e.currentTarget.style.borderColor = "rgba(142, 144, 153, 0.2)"; e.currentTarget.style.color = "#dae2fd"; }}
                                    >
            ...
            <nav style={{ position: "fixed", bottom: 0, left: 0, right: 0, display: "flex", justifyContent: "center", alignItems: "center", gap: "16px", padding: "20px 40px", background: "rgba(6,14,32,0.9)", backdropFilter: "blur(32px)", borderTop: "1px solid rgba(68,71,78,0.3)", boxShadow: "0px -10px 30px rgba(0,0,0,0.4)", borderTopLeftRadius: "12px", borderTopRightRadius: "12px", zIndex: 50 }}>
                <button onClick={() => navigate(-1)} style={{ display: "flex", flexDirection: "column", alignItems: "center", color: "#c4c6cf", padding: "12px 48px", background: "transparent", border: "none", cursor: "pointer", borderRadius: "12px", fontSize: "14px", fontWeight: "600", textTransform: "uppercase" }}
                ...
                <button onClick={() => navigate("/")} style={{ display: "flex", flexDirection: "column", alignItems: "center", color: "#c4c6cf", padding: "12px 48px", background: "transparent", border: "none", cursor: "pointer", borderRadius: "12px", fontSize: "14px", fontWeight: "600", textTransform: "uppercase" }}
